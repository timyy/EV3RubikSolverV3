...
import EV3RubikSolver.solver.testSolver;
	   ...
	   public static void main(String[] args)
	    {
		   ...
		   while(true) {
			   try {
				   System.out.print("Read all side\n");
				   // Robot.ReadOneSide(0);
				   Robot.ReadAllSide();
		...
		public static void testRobot_readColor()
		{
...
//	            Delay.msDelay(1000);
	  ...
	  public static void testRubik_Solver()
		{
	        GraphicsLCD g = BrickFinder.getDefault().getGraphicsLCD();
	        g.setFont(Font.getDefaultFont());
